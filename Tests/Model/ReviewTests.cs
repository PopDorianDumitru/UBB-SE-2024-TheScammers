...
namespace Tests.Model
{
    ...
    {
        public Review reviewToTest1, reviewToTest2, reviewToTest3;
        ...
        [Test]
        public void IdGet_GetTheIdReviewFirstConstructor_ShouldBeNotEmpty()
        {
            Assert.That(reviewToTest1.Id, Is.Not.EqualTo(Guid.Empty));

        }
        [Test]
        public void IdGet_GetTheIdReviewSecondConstructor_ShouldBeNotEmpty()
        {
            Assert.That(reviewToTest2.Id, Is.Not.EqualTo(Guid.Empty));

        }
        [Test]
        public void IdGet_GetTheIdReviewThirdConstructor_ShouldBeNotEmpty()
        {
            Assert.That(reviewToTest3.Id, Is.Not.EqualTo(Guid.Empty));

        }
        [Test]
        public void GroupIdIdGet_GetTheGroupIdReviewFirstConstructor_ShouldBeNotEmpty()
        {
            Assert.That(reviewToTest1.GroupId, Is.Not.EqualTo(Guid.Empty));

        }
        [Test]
        public void GroupIdGet_GetTheGroupIdReviewSecondConstructor_ShouldBeNotEmpty()
        {
            Assert.That(reviewToTest2.GroupId, Is.Not.EqualTo(Guid.Empty));

        }
        [Test]
        public void GroupIdGet_GetTheGroupIdReviewThirdConstructor_ShouldBeNotEmpty()
        {
            Assert.That(reviewToTest3.GroupId, Is.Not.EqualTo(Guid.Empty));

        }
        [Test]
        public void GroupIdSet_SetTheGroupIdReportThirdConstructor_ShouldBeEqualWithTheNewId()
        {
